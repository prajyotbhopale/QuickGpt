...
const Sidebar = ({ isMenuOpen, setIsMenuOpen }) => {
  ...
  return (
    <div className={`flex flex-col h-screen min-w-72 p-5 dark:bg-gradient-to-b from-[#24221A]/30 to-[#0E0000]/30 border-r border-[#860699]/30 backdrop-blur-3xl transition-all duration-500 max-md:absolute left-0 z-[1] ${!isMenuOpen && 'max-md:-translate-x-full'}`}>
      {/* LOGO */}
      <img
      ...
      {/* NEW CHAT BUTTON */}
      <button className="flex justify-center items-center w-full py-2 mt-10 text-white bg-gradient-to-r from-[#A45F67] to-[#3D81F6] text-sm rounded-md cursor-pointer">
