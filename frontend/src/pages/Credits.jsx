        ...
        {plans.map((plan) => (
          ...
          >
            <div className="flex-1">
              ...
              <p className="text-2xl fond-bold text-purple-600 dark:text-purple-300 mb-4">
                ${plan.price}
              </p>
            ...
            <button className="mt-4 bg-purple-600 hover:bg-purple-700 active:bg-purple-800 text-white font-medium py-2 rounded transition-colors cursor-pointer">
              Buy Now
            </button>
          </div>
        ))}
